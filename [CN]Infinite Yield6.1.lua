--[[  中文版脚本持续更新地址为 https://wwin.lanzouw.com/b007t43mzc   密码均为1234
原版官网为https://infyiff.github.io/
我(译者)的B站账号:https://space.bilibili.com/702241161（如果有问题可以找我，一起玩可以加CFL_KG这个号）
更新日记:2024/12/12大部分菜单功能啥的都翻译完了
笔记：设置UI 404行/一个菜单(忘了是什么了,可能是主菜单) 2183行/翻译究极折磨的参考菜单 2656行/文件写入 2935行/功能篇 4301行/
text =     notify(
    （标/？为不确定）]]--

if IY_LOADED and not _G.IY_DEBUG == true then
	error("Infinite Yield 正在运行!", 0)
	return
end
...
if not game:IsLoaded() then
	...
	notLoaded.Text = "Infinite Yield正在等待游戏加载"
	game.Loaded:Wait()
	notLoaded:Destroy()
end
--游戏版本
...
--设置UI 404
ColorsButton = makeSettingsButton("颜色修改","rbxassetid://4911962991")
ColorsButton.Position = UDim2.new(0,5,0,55)
ColorsButton.Size = UDim2.new(1,-10,0,25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("按键绑定","rbxassetid://129697930")
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("编辑别名","rbxassetid://5147488658")
...
Positions = makeSettingsButton("目标点菜单","rbxassetid://5147488592")
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("事件绑定","rbxassetid://5147695474",759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("管理插件","rbxassetid://5147695474",743)
...
Credits.Text = "//关注Bilibili安静的泥鳅谢谢喵//"
...
Directions.Text = "单击下面的按钮，然后按按键/鼠标按钮。然后选择要将其绑定到的指令."
...
Cmdbar_3.PlaceholderText = "输入指令 2"
Cmdbar_3.Text = ""
...
About.TextSize = 14
About.Text = "插件是.iy文件，应位于注入器的'workspace'文件夹中."
...
Directions_2.Text = "在下面键入要添加的插件文件的名称."
...
PluginsHint.Text = "从IY Discord下载插件（Discord.gg/78ZuWSq）"
...
PositionsHint.Text = "使用'swp'或'setwaypoint'命令使用您的角色添加位置（注意：零件传送不会保存）"
...
Directions_3.Text = '点击一个零件，然后点击下面的“选择零件”按钮，将其设置为传送位置'
...
reference = (function()
	local main = create({
		...
		{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={2},Size=UDim2.new(1,0,0.94999998807907,0),Text="参考",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{4,"TextButton",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Close",Parent={2},Position=UDim2.new(1,-20,0,0),Size=UDim2.new(0,20,0,20),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://5054663650",Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{10,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={9},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="特殊玩家组案例(有问题可以去b站搜UID702241161在用户中找到我的账号)",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={9},Position=UDim2.new(0,8,0,25),Size=UDim2.new(1,-8,0,20),Text="这些关键字可用于在命令中快速选择玩家组：(所有中文为安静的泥鳅翻译校准,B站同名)",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{17,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={15},Position=UDim2.new(0,15,0,0),Size=UDim2.new(1,0,1,0),Text="- 所有人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={18},Position=UDim2.new(0,37,0,0),Size=UDim2.new(1,0,1,0),Text="- 除你以外的所有人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{23,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={21},Position=UDim2.new(0,19,0,0),Size=UDim2.new(1,0,1,0),Text="- 你自己",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{25,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="CaseName",Parent={24},Size=UDim2.new(1,0,1,0),Text="#[数字]",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{26,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={24},Position=UDim2.new(0,59,0,0),Size=UDim2.new(1,0,1,0),Text="- 随机抽取这个数量的玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{29,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={27},Position=UDim2.new(0,44,0,0),Size=UDim2.new(1,0,1,0),Text="- 随机一个玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{31,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="CaseName",Parent={30},Size=UDim2.new(1,0,1,0),Text="%[团队名称]",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{32,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={30},Position=UDim2.new(0,78,0,0),Size=UDim2.new(1,0,1,0),Text="- 这个团队的所有玩家",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{35,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={33},Position=UDim2.new(0,63,0,0),Size=UDim2.new(1,0,1,0),Text="- 你这个团队的",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{38,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={36},Position=UDim2.new(0,101,0,0),Size=UDim2.new(1,0,1,0),Text="- 非你这个团队的",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{41,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={39},Position=UDim2.new(0,40,0,0),Size=UDim2.new(1,0,1,0),Text="- ROBLOX中的好友",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{44,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={42},Position=UDim2.new(0,61,0,0),Size=UDim2.new(1,0,1,0),Text="- 不是你ROBLOX中的朋友的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{47,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={45},Position=UDim2.new(0,36,0,0),Size=UDim2.new(1,0,1,0),Text="- 游客玩家（无用）",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{50,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={48},Position=UDim2.new(0,40,0,0),Size=UDim2.new(1,0,1,0),Text="- 有着'培根'头发的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{52,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="CaseName",Parent={51},Size=UDim2.new(1,0,1,0),Text="age[数字]",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{53,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={51},Position=UDim2.new(0,71,0,0),Size=UDim2.new(1,0,1,0),Text="- 达到或低于这个年龄的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{55,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="CaseName",Parent={54},Size=UDim2.new(1,0,1,0),Text="rad[数字]",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{56,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={54},Position=UDim2.new(0,70,0,0),Size=UDim2.new(1,0,1,0),Text="- i这个半径范围内的所有人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{59,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={57},Position=UDim2.new(0,43,0,0),Size=UDim2.new(1,0,1,0),Text="- 离你最近的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{62,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={60},Position=UDim2.new(0,46,0,0),Size=UDim2.new(1,0,1,0),Text="- 离你最远的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{65,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={63},Position=UDim2.new(0,55,0,0),Size=UDim2.new(1,0,1,0),Text="- 特定组的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{68,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={66},Position=UDim2.new(0,27,0,0),Size=UDim2.new(1,0,1,0),Text="- 活着的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{71,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="CaseDesc",Parent={69},Position=UDim2.new(0,29,0,0),Size=UDim2.new(1,0,1,0),Text="- 死掉的人",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{76,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={75},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="各种运算(这个页面的文字太乱太难理解太废眼睛了,部分我直接用机翻了)",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		...
		{79,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={75},Position=UDim2.new(0,8,0,75),Size=UDim2.new(1,-8,0,16),Text="使用-排除，使用+在添加表达式中包含玩家：",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{80,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={75},Position=UDim2.new(0,8,0,91),Size=UDim2.new(1,-8,0,16),Text=";locate %blue-friends（获取蓝色团队中不是您好友的玩家）",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{82,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={75},Position=UDim2.new(0,8,0,120),Size=UDim2.new(1,-8,0,16),Text="放！在使用最后一个参数运行它的命令之前：",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{83,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={75},Position=UDim2.new(0,8,0,136),Size=UDim2.new(1,-8,0,32),Text="运行后;offset 0 100 0,，你可以跑了用!offset随时可以使用上次运行该命令时使用的相同参数重复该命令",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{85,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={84},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="指令循环",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{86,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={84},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,20),Text="形式：[循环次数]^[延迟（可选）]^[命令]",TextColor3=Color3.new(1,1,1),TextSize=15,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{88,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={84},Position=UDim2.new(0,8,0,50),Size=UDim2.new(1,-8,0,20),Text="使用“breakloops”指令停止所有正在运行的循环。",TextColor3=Color3.new(1,1,1),TextSize=15,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{89,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={84},Position=UDim2.new(0,8,0,80),Size=UDim2.new(1,-8,0,16),Text="使用例::",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{90,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={84},Position=UDim2.new(0,8,0,98),Size=UDim2.new(1,-8,0,42),Text=";5^btools - 给你5个btools\n;10^3^drophats - 每3秒放下帽子10次 times\n;inf^0.1^animspeed 100 - 将动画速度无限循环到100",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{92,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={91},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="一次执行多个命令",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{93,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={91},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,20),Text="您可以使用以下命令一次执行多个命令 \"\\\"",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{95,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={91},Position=UDim2.new(0,8,0,60),Size=UDim2.new(1,-8,0,16),Text="使用例:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{96,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={91},Position=UDim2.new(0,8,0,78),Size=UDim2.new(1,-8,0,32),Text=";drophats\\respawn - 扔下帽子并重生\n;enable inventory\\enable playerlist\\refresh - 启用这些coregui项并刷新你",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{98,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={97},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="浏览命令历史记录",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{99,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={97},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="当你在使用命令栏时，可以使用上下箭头键浏览最近使用的命令",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{103,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={101},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="当您专注于命令栏时，可以使用tab键将顶部建议的命令插入到命令栏中.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{106,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={105},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="使用按键绑定",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{107,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={105},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="使用事件绑定来设置在特定事件发生时执行的命令。您可以编辑事件命令运行的条件（例如哪个玩家触发它）.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{109,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={105},Position=UDim2.new(0,8,0,70),Size=UDim2.new(1,-8,0,48),Text="有些事件可能会引发争论；您可以在事件命令中使用它们，方法是使用$后跟参数号（$1、$2等）。您可以通过查看事件命令的设置来了解这些参数的顺序和类型.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{110,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Text",Parent={105},Position=UDim2.new(0,8,0,130),Size=UDim2.new(1,-8,0,16),Text="使用例:",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		{111,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={105},Position=UDim2.new(0,8,0,148),Size=UDim2.new(1,-8,0,16),Text="设置'goto $1' 在OnChatted事件中，您将被传送到任何聊天的玩家.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,TextYAlignment=0,ZIndex=10,}},
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="您可以加入Discord服务器以获得IY的支持，并阅读更多文档，如插件API.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
	...
	inviteButton.MouseButton1Click:Connect(function()
		if everyClipboard then
			...
			inviteButton.Text = "复制"
		else
			inviteButton.Text = "无剪贴板功能，请键入链接"
		end
		local pressTime = tick()
		lastPress = pressTime
		wait(2)
		if lastPress ~= pressTime then return end
		inviteButton.Text = "复制Discord邀请链接 (https://discord.gg/78ZuWSq)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
function saves()--文件写入 2935行
	if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
		...
		if readSuccess then
			if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
				...
				if dReadSuccess and dOut ~= nil and tostring(dOut):gsub("%s", "") ~= "" then
					...
					nosaves = true
					useFactorySettings()
					createPopup("将保存文件写入电脑时出现问题.\n\n请联系开发者/支持团队使用注入器并告诉他们writefile/readfile不工作.\n\n如果你继续,您的设置, 按键绑定, 坐标点, 和别名菜单将不会保存.\n\n需尝试事情:\n> 确保一个 'workspace' 文件夹与您的注入器位于同一文件夹中\n> 如果你的注入器在ZIP/RAR 文件中的话, 请把它解压出来.\n> 重新加入游戏并重试，或重新启动电脑并重试.")
				end
			end
		else
			writefile("IY_FE.iy", defaults, true)
		...
		if jsonAttempts >= 10 then
			nosaves = true
			useFactorySettings()
			createPopup("很抱歉, 我们已尝试解析您的保存文件，但无法读取!\n\nInfinite Yield现在正在使用默认设置，直到注入器的文件系统工作为止.\n\n您的保存文件尚未删除.")
		else
			nosaves = true
			useFactorySettings()
		end
...
if not writefileExploit() then
	notify("保存", "您的注入器不支持读/写文件。您的设置将不会保存.")
end
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			nameFile()
			notify('聊天记录','将聊天日志保存到注入器文件夹中的workspace文件夹.')
		end
	else
		notify('聊天日志','您的注入器不支持写入文件。你无法保存聊天日志.')
	end
end)
	...
	if Path.Text ~= "" then
		...
		local function handleWpNames()
			...
			if not FoundDupe then
				notify('修改航点',"创建航路点: "..selected.Adornee.Name..tpNameExt)
...
PrefixBox:GetPropertyChangedSignal("Text"):Connect(function()
	...
	Cmdbar.PlaceholderText = "在此搜索指令 ("..prefix..")"
	updatesaves()
end)
...
--功能篇 4301行
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = '邀请你进入Infinite Yield的discord服务器'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = '加载Roblox控制台'}
CMDs[#CMDs + 1] = {NAME = 'oldconsole', DESC = '加载旧的Roblox控制台'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = '打开 DEX '}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = '打开 老DEX '}
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy', DESC = '打开 Simple Spy V3'}
CMDs[#CMDs + 1] = {NAME = 'audiologger / alogger', DESC = '打开 Edges audio logger'}
CMDs[#CMDs + 1] = {NAME = 'serverinfo / info', DESC = '让你查看此服务器信息'}
CMDs[#CMDs + 1] = {NAME = 'jobid', DESC = '将游戏的JobId复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'notifyjobid', DESC = '告诉你游戏的JobId'}
CMDs[#CMDs + 1] = {NAME = 'rejoin / rj', DESC = '让你重新加入这个服务器'}
CMDs[#CMDs + 1] = {NAME = 'autorejoin / autorj', DESC = '如果被踢/断开连接，则自动重新加入此服务器'}
CMDs[#CMDs + 1] = {NAME = 'serverhop / shop', DESC = '随机传送你到此游戏的其他服务器'}
CMDs[#CMDs + 1] = {NAME = 'joinplayer [username / ID] [place ID]', DESC = '加入特定玩家在的服务器(追杀是吧)'}
CMDs[#CMDs + 1] = {NAME = 'gameteleport / gametp [place ID]', DESC = '通过游戏ID加入游戏(切换到其他游戏)'}
CMDs[#CMDs + 1] = {NAME = 'antiidle / antiafk', DESC = '防止你在挂机的时候被踢出'}
CMDs[#CMDs + 1] = {NAME = 'datalimit [num]', DESC = '设置传出KBPS的限制'}
CMDs[#CMDs + 1] = {NAME = 'replicationlag / backtrack [num]', DESC = '设置收入数据延迟'}
CMDs[#CMDs + 1] = {NAME = 'creatorid / creator', DESC = '用IY笔记通知你作者的ID'}
CMDs[#CMDs + 1] = {NAME = 'copycreatorid / copycreator', DESC = '复制作者的ID'}
CMDs[#CMDs + 1] = {NAME = 'setcreatorid / setcreator', DESC = '将您的用户ID设置为作者ID'}
CMDs[#CMDs + 1] = {NAME = 'noprompts', DESC = '防止游戏向您显示购买/会员提示'}
CMDs[#CMDs + 1] = {NAME = 'showprompts', DESC = '允许游戏向您显示购买/会员提示'}
CMDs[#CMDs + 1] = {NAME = 'enable [inventory/playerlist/chat/reset/emotes/all]', DESC = '切换coregui项目的可见性'}
CMDs[#CMDs + 1] = {NAME = 'disable [inventory/playerlist/chat/reset/emotes/all]', DESC = '切换coregui项目的可见性'}
CMDs[#CMDs + 1] = {NAME = 'showguis', DESC = '显示所有不可见的UI'}
CMDs[#CMDs + 1] = {NAME = 'unshowguis', DESC = '取消显示所有不可见的UI'}
CMDs[#CMDs + 1] = {NAME = 'hideguis', DESC = '隐藏所有UI'}
CMDs[#CMDs + 1] = {NAME = 'unhideguis', DESC = '取消隐藏所有UI'}
CMDs[#CMDs + 1] = {NAME = 'guidelete', DESC = '启用退格(←)键删除UI'}
CMDs[#CMDs + 1] = {NAME = 'unguidelete / noguidelete', DESC = '取消启用退格(←)键删除UI'}
CMDs[#CMDs + 1] = {NAME = 'hideiy', DESC = '隐藏IY的UI(默认按;键呼出)'}
CMDs[#CMDs + 1] = {NAME = 'showiy / unhideiy', DESC = '显示IY的UI'}
CMDs[#CMDs + 1] = {NAME = 'keepiy', DESC = '在服务器传送后自动执行/启动IY'}
CMDs[#CMDs + 1] = {NAME = 'unkeepiy', DESC = '取消在服务器传送后自动执行/启动IY'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepiy', DESC = '切换保持在服务器传送后自动执行/启动IY'}
CMDs[#CMDs + 1] = {NAME = 'savegame / saveplace', DESC = '使用saveinstance保存游戏'}
CMDs[#CMDs + 1] = {NAME = 'clearerror', DESC = '游戏踢出你时清除提示框并模糊'}--/？
CMDs[#CMDs + 1] = {NAME = 'clientantikick / antikick (CLIENT)', DESC = '防止你被本地脚本踢出'}
CMDs[#CMDs + 1] = {NAME = 'clientantiteleport / antiteleport (CLIENT)', DESC = '防止本地脚本传送你'}
CMDs[#CMDs + 1] = {NAME = 'allowrejoin / allowrj [true/false] (CLIENT)', DESC = '是否允许使用反传送功能重新加入'}
CMDs[#CMDs + 1] = {NAME = 'cancelteleport / canceltp', DESC = '取消正在进行的传送'}
CMDs[#CMDs + 1] = {NAME = 'volume / vol [0-10]', DESC = '在0到10的范围内调整游戏音量'}
CMDs[#CMDs + 1] = {NAME = 'antilag / boostfps / lowgraphics', DESC = '降低游戏画质以提高帧率'}
CMDs[#CMDs + 1] = {NAME = 'record / rec', DESC = '启动roblox自带的录屏'}
CMDs[#CMDs + 1] = {NAME = 'screenshot / scrnshot', DESC = '截图'}
CMDs[#CMDs + 1] = {NAME = 'togglefullscreen / togglefs', DESC = '切换全屏'}
CMDs[#CMDs + 1] = {NAME = 'notify [text]', DESC = '使用输入的文本向你的IY发送通知'}
CMDs[#CMDs + 1] = {NAME = 'lastcommand / lastcmd', DESC = '执行上一条指令'}
CMDs[#CMDs + 1] = {NAME = 'exit', DESC = '结束ROBLOX的进程'}
CMDs[#CMDs + 1] = {NAME = '//飞行穿墙篇//', DESC = '译者:bilibili安静的泥鳅'}
CMDs[#CMDs + 1] = {NAME = 'noclip', DESC = '启用穿墙'}
CMDs[#CMDs + 1] = {NAME = 'unnoclip / clip', DESC = '禁用穿墙'}
CMDs[#CMDs + 1] = {NAME = 'fly [speed]', DESC = '让你可以飞行(默认速度为20)'}
CMDs[#CMDs + 1] = {NAME = 'unfly', DESC = '禁用飞行'}
CMDs[#CMDs + 1] = {NAME = 'flyspeed [num]', DESC = '设置飞行速度(默认速度为20)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclefly / vfly [speed]', DESC = '让你可以在载具中飞行'}
CMDs[#CMDs + 1] = {NAME = 'unvehiclefly / unvfly', DESC = '禁用载具飞行'}
CMDs[#CMDs + 1] = {NAME = 'vehicleflyspeed  / vflyspeed [num]', DESC = '设置载具飞行速度'}
CMDs[#CMDs + 1] = {NAME = 'cframefly / cfly [speed]', DESC = '让你可以飞行，可绕过一些反作弊(适用于手机)'}
CMDs[#CMDs + 1] = {NAME = 'uncframefly / uncfly', DESC = '禁用cfly飞行'}
CMDs[#CMDs + 1] = {NAME = 'cframeflyspeed  / cflyspeed [num]', DESC = '设置cfly速度'}
CMDs[#CMDs + 1] = {NAME = 'qefly [true / false]', DESC = '启用/禁用QE飞行(Q下降E上升)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclenoclip / vnoclip', DESC = '关闭载具碰撞'}
CMDs[#CMDs + 1] = {NAME = 'vehicleclip / vclip / unvnoclip', DESC = '启用载具碰撞'}
CMDs[#CMDs + 1] = {NAME = 'float /  platform', DESC = '在你下方形成一个平台，来让你悬空'}
CMDs[#CMDs + 1] = {NAME = 'unfloat / noplatform', DESC = '删除平台'}
CMDs[#CMDs + 1] = {NAME = 'swim', DESC = '让你可以在任何地方游泳'}
CMDs[#CMDs + 1] = {NAME = 'unswim / noswim', DESC = '禁用让你可以在任何地方游泳'}
CMDs[#CMDs + 1] = {NAME = '//坐标点篇//', DESC = 'tip:(CLIENT)是客户端的意思,只有你自己可见'}
CMDs[#CMDs + 1] = {NAME = 'setwaypoint / swp [name]', DESC = '在你所在的位置设置标点'}
CMDs[#CMDs + 1] = {NAME = 'waypointpos / wpp [name] [X Y Z]', DESC = '设置有指定地点的标点'}
CMDs[#CMDs + 1] = {NAME = 'waypoints', DESC = '显示标点列表'}
CMDs[#CMDs + 1] = {NAME = 'showwaypoints / showwp', DESC = '显示当前设置的所有标点'}
CMDs[#CMDs + 1] = {NAME = 'hidewaypoints / hidewp', DESC = '显示当前设置的所有标点'}
CMDs[#CMDs + 1] = {NAME = 'waypoint / wp [name]', DESC = '将你传送到标点'}
CMDs[#CMDs + 1] = {NAME = 'tweenwaypoint / twp [name]', DESC = '将你推到标点'}
CMDs[#CMDs + 1] = {NAME = 'walktowaypoint / wtwp [name]', DESC = '让你自动寻路至一个航点'}
CMDs[#CMDs + 1] = {NAME = 'deletewaypoint / dwp [name]', DESC = '删除选择的标点'}
CMDs[#CMDs + 1] = {NAME = 'clearwaypoints / cwp', DESC = '清除所有标点'}
CMDs[#CMDs + 1] = {NAME = 'cleargamewaypoints / cgamewp', DESC = '清除您所在游戏的所有航路点'}
CMDs[#CMDs + 1] = {NAME = '//玩家位置篇//', DESC = '翻译工作全是安静的泥鳅单人完成'}
CMDs[#CMDs + 1] = {NAME = 'goto [player]', DESC = '传送到指定玩家处'}
CMDs[#CMDs + 1] = {NAME = 'tweengoto / tgoto [player]', DESC = '把你推到指定玩家处 (可以绕过一些反作弊)'}
CMDs[#CMDs + 1] = {NAME = 'tweenspeed / tspeed [num]', DESC = '设置移动到某地指令的速度 (默认为 1)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclegoto / vgoto [player]', DESC = '在车中传送到指定玩家'}
CMDs[#CMDs + 1] = {NAME = 'loopgoto [player] [distance] [delay]', DESC = '环形传送到玩家'}--/？
CMDs[#CMDs + 1] = {NAME = 'unloopgoto', DESC = '停止环形传送到玩家'}
CMDs[#CMDs + 1] = {NAME = 'pulsetp / ptp [player] [seconds]', DESC = '将你传送到一个玩家身边一段时间'}
CMDs[#CMDs + 1] = {NAME = 'clientbring / cbring [player] (CLIENT)', DESC = '带来某位玩家'}
CMDs[#CMDs + 1] = {NAME = 'loopbring [player] [distance] [delay] (CLIENT)', DESC = '让你环绕某个玩家(可以攻击)'}--/？
CMDs[#CMDs + 1] = {NAME = 'unloopbring [player]', DESC = '停止loopbring'}
CMDs[#CMDs + 1] = {NAME = 'freeze / fr [player] (CLIENT)', DESC = '冰冻指定玩家'}
CMDs[#CMDs + 1] = {NAME = 'freezeanims', DESC = '冻结动画/暂停动画-对默认动画无效'}
CMDs[#CMDs + 1] = {NAME = 'unfreezeanims', DESC = '解冻动画/播放动画'}
CMDs[#CMDs + 1] = {NAME = 'thaw / unfr [player] (CLIENT)', DESC = '解冻玩家'}
CMDs[#CMDs + 1] = {NAME = 'tpposition / tppos [X Y Z]', DESC = '把你传送到特定的坐标'}
CMDs[#CMDs + 1] = {NAME = 'tweentpposition / ttppos [X Y Z]', DESC = '推你到特定坐标(绕过一些反作弊)'}
CMDs[#CMDs + 1] = {NAME = 'offset [X Y Z]', DESC = '让你偏移一定的坐标'}--/？
CMDs[#CMDs + 1] = {NAME = 'tweenoffset / toffset [X Y Z]', DESC = '推你偏移坐标(绕过一些反作弊)'}--？
CMDs[#CMDs + 1] = {NAME = 'notifyposition / notifypos [player]', DESC = '通知你一个玩家的坐标'}
CMDs[#CMDs + 1] = {NAME = 'copyposition / copypos [player]', DESC = '将玩家的坐标复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'walktoposition / walktopos [X Y Z]', DESC = '让你自动寻路走向坐标'}
CMDs[#CMDs + 1] = {NAME = 'spawnpoint / spawn [delay]', DESC = '设置重生点的位置'}
CMDs[#CMDs + 1] = {NAME = 'nospawnpoint / nospawn', DESC = '移除您的自定义重生点'}
CMDs[#CMDs + 1] = {NAME = 'flashback / diedtp', DESC = '传送到你上一次死亡的地点'}
CMDs[#CMDs + 1] = {NAME = 'walltp', DESC = '将你传送到你碰到的任何墙壁之上'}
CMDs[#CMDs + 1] = {NAME = 'nowalltp / unwalltp', DESC = '禁用walltp'}
CMDs[#CMDs + 1] = {NAME = 'teleporttool / tptool', DESC = '给你一个传送工具'}
CMDs[#CMDs + 1] = {NAME = '//聊天篇//', DESC = '翻译完功能扔ROBLOXstudio里面一看有349个错误直接给我气红温了'}
CMDs[#CMDs + 1] = {NAME = 'logs', DESC = '打开日志UI,可查看服务器中的聊天(私聊也可)和加入服务器记录'}
CMDs[#CMDs + 1] = {NAME = 'chatlogs / clogs', DESC = '查看记录他人的聊天'}
CMDs[#CMDs + 1] = {NAME = 'joinlogs / jlogs', DESC = '记录他人加入日志'}
CMDs[#CMDs + 1] = {NAME = 'antichatlogs / antichatlogger', DESC = '防止ROBLOX因为你瞎JB说话ban你 (游戏需要旧版聊天)'}--/？
CMDs[#CMDs + 1] = {NAME = 'chat / say [text]', DESC = '让你说话（可能绕过屏蔽/禁言）'}--/？
CMDs[#CMDs + 1] = {NAME = 'spam [text]', DESC = '让你发送垃圾邮件聊天'}
CMDs[#CMDs + 1] = {NAME = 'unspam', DESC = '关闭垃圾邮件'}
CMDs[#CMDs + 1] = {NAME = 'whisper / pm [player] [text]', DESC = '私聊指定玩家（可能绕过屏蔽/禁言）'}--/？
CMDs[#CMDs + 1] = {NAME = 'pmspam [player] [text]', DESC = '让你私聊发垃圾邮件'}
CMDs[#CMDs + 1] = {NAME = 'unpmspam [player]', DESC = '关闭让你私聊发垃圾邮件'}
CMDs[#CMDs + 1] = {NAME = 'spamspeed [num]', DESC = '发送垃圾邮件的速度(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'bubblechat (CLIENT)', DESC = '为您的客户端启用泡泡聊天'}
CMDs[#CMDs + 1] = {NAME = 'unbubblechat / nobubblechat', DESC = '禁用bubblechat'}
CMDs[#CMDs + 1] = {NAME = 'safechat', DESC = '启用安全聊天'}
CMDs[#CMDs + 1] = {NAME = 'nosafechat / disablesafechat', DESC = '禁用安全聊天'}
CMDs[#CMDs + 1] = {NAME = '//透视篇//', DESC = '但是那349个错误我还是成功解修复啦'}
CMDs[#CMDs + 1] = {NAME = 'esp', DESC = '透视所有玩家和显示状态'}
CMDs[#CMDs + 1] = {NAME = 'noesp / unesp', DESC = '禁用透视'}
CMDs[#CMDs + 1] = {NAME = 'esptransparency [number]', DESC = '更改esp相关命令的透明度'}
CMDs[#CMDs + 1] = {NAME = 'partesp [part name]', DESC = '高亮透视指定物体,例如head'}
CMDs[#CMDs + 1] = {NAME = 'unpartesp / nopartesp [part name]', DESC = '禁用高亮透视指定物体'}
CMDs[#CMDs + 1] = {NAME = 'chams', DESC = '普通透视,但是没有玩家状态'}
CMDs[#CMDs + 1] = {NAME = 'nochams / unchams', DESC = '禁用人物透视'}
CMDs[#CMDs + 1] = {NAME = 'locate [player]', DESC = '针对查看单个玩家及其状态'}
CMDs[#CMDs + 1] = {NAME = 'unlocate / nolocate [player]', DESC = '禁用针对透视'}
CMDs[#CMDs + 1] = {NAME = 'xray', DESC = '让所有物体变半透明'}
CMDs[#CMDs + 1] = {NAME = 'unxray / noxray', DESC = '禁用X光'}
CMDs[#CMDs + 1] = {NAME = 'loopxray', DESC = '使地图中的所有部分透明但呈环状'}--/？
CMDs[#CMDs + 1] = {NAME = 'unloopunxray', DESC = '取消loopxray'}
CMDs[#CMDs + 1] = {NAME = '//摄像机篇//', DESC = '关注bilibili安静的泥鳅谢谢喵'}
CMDs[#CMDs + 1] = {NAME = 'spectate / view [player]', DESC = '让你观战某个玩家'}
CMDs[#CMDs + 1] = {NAME = 'viewpart / viewp [part name]', DESC = '让你观战某个物体'}
CMDs[#CMDs + 1] = {NAME = 'unspectate / unview', DESC = '停止观战某个玩家'}
CMDs[#CMDs + 1] = {NAME = 'freecam / fc', DESC = '允许您在游戏中自由移动相机'}
CMDs[#CMDs + 1] = {NAME = 'freecampos / fcpos [X Y Z]', DESC = '移动 / 打开自由相机在指定位置'}
CMDs[#CMDs + 1] = {NAME = 'freecamwaypoint / fcwp [name]', DESC = '移动/打开freecam到一个标点'}
CMDs[#CMDs + 1] = {NAME = 'freecamgoto / fcgoto / fctp [player]', DESC = '在某人位置移动/打开freecam'}
CMDs[#CMDs + 1] = {NAME = 'unfreecam / unfc', DESC = '禁用自由相机'}
CMDs[#CMDs + 1] = {NAME = 'freecamspeed / fcspeed [num]', DESC = '调整freecam速度(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'notifyfreecamposition / notifyfcpos', DESC = '通知你你的freecam坐标'}
CMDs[#CMDs + 1] = {NAME = 'copyfreecamposition / copyfcpos', DESC = '将freecam坐标复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'gotocamera / gotocam', DESC = '传送你到你相机的位置'}
CMDs[#CMDs + 1] = {NAME = 'tweengotocam / tgotocam', DESC = '推你到你的相机的位置'}
CMDs[#CMDs + 1] = {NAME = 'firstp', DESC = '强制镜头进入第一人称'}
CMDs[#CMDs + 1] = {NAME = 'thirdp', DESC = '让你变成第三人称'}
CMDs[#CMDs + 1] = {NAME = 'noclipcam / nccam', DESC = '允许让你的摄像机穿墙'}
CMDs[#CMDs + 1] = {NAME = 'maxzoom [num]', DESC = '设置相机最大视野(可开第三人称)'}
CMDs[#CMDs + 1] = {NAME = 'minzoom [num]', DESC = '设置相机最小视野'}
CMDs[#CMDs + 1] = {NAME = 'camdistance [num]', DESC = '改变相机与玩家的距离'}
CMDs[#CMDs + 1] = {NAME = 'fov [num]', DESC = '更改你的FOV (默认为70)'}
CMDs[#CMDs + 1] = {NAME = 'fixcam / restorecam', DESC = '修复相机'}
CMDs[#CMDs + 1] = {NAME = 'enableshiftlock / enablesl', DESC = '启用shift锁定选项'}
CMDs[#CMDs + 1] = {NAME = 'lookat [player]', DESC = '将您的摄像机视图移动到玩家'}
CMDs[#CMDs + 1] = {NAME = '//地图场景篇//', DESC = '中文版持续更新地址为https://wwin.lanzouw.com/b007t43mzc'}
CMDs[#CMDs + 1] = {NAME = 'btools (CLIENT)', DESC = '为您提供建筑工具(不再生)'}
CMDs[#CMDs + 1] = {NAME = 'f3x (CLIENT)', DESC = '为您提供F3X建筑工具(不再生)'}
CMDs[#CMDs + 1] = {NAME = 'partname / partpath', DESC = '允许您单击某个部件以查看其路径和名称'}
CMDs[#CMDs + 1] = {NAME = 'delete [instance name] (CLIENT)', DESC = '从地图移除任何具有特定名称的零件(不再生)'}
CMDs[#CMDs + 1] = {NAME = 'deleteclass / dc [class name] (CLIENT)', DESC = '从地图中删除任何具有特定类名的部分(不再生)'}
CMDs[#CMDs + 1] = {NAME = 'lockworkspace / lockws', DESC = '锁定整个地图'}
CMDs[#CMDs + 1] = {NAME = 'unlockworkspace / unlockws', DESC = '取消锁定整个地图'}
CMDs[#CMDs + 1] = {NAME = 'invisibleparts / invisparts (CLIENT)', DESC = '显示隐藏的物体'}
CMDs[#CMDs + 1] = {NAME = 'uninvisibleparts / uninvisparts (CLIENT)', DESC = '使隐形物体影响的零件恢复正常'}
CMDs[#CMDs + 1] = {NAME = 'deleteinvisparts / dip (CLIENT)', DESC = '删除隐藏的物体'}
CMDs[#CMDs + 1] = {NAME = 'gotopart [part name]', DESC = '将角色移动到一个或多个物体'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopart / tgotopart [part name]', DESC = '将角色推到一个或多个物体'}
CMDs[#CMDs + 1] = {NAME = 'gotopartclass / gpc [class name]', DESC = '基于类名将角色传送到一个或多个物体'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopartclass / tgpc [class name]', DESC = '基于类名将角色推到一个或多个物体'}
CMDs[#CMDs + 1] = {NAME = 'gotomodel [part name]', DESC = '将角色移动到一个或多个物体'}
CMDs[#CMDs + 1] = {NAME = 'tweengotomodel / tgotomodel [part name]', DESC = '将角色推到一个或多个模型'}
CMDs[#CMDs + 1] = {NAME = 'gotopartdelay / gotomodeldelay [num]', DESC = '调整你传送到每个部分的速度(默认为0.1)'}
CMDs[#CMDs + 1] = {NAME = 'bringpart [part name] (CLIENT)', DESC = '将一个或多个部分移动到角色'}
CMDs[#CMDs + 1] = {NAME = 'bringpartclass / bpc [class name] (CLIENT)', DESC = '基于类名将一个或多个部分移动到角色'}
CMDs[#CMDs + 1] = {NAME = 'noclickdetectorlimits / nocdlimits', DESC = '将所有点击检测器MaxActivationDistance设置为math.huge'}--/？
CMDs[#CMDs + 1] = {NAME = 'fireclickdetectors / firecd [name]', DESC = '使用游戏中的所有点击检测器或使用可选名称'}--/？
CMDs[#CMDs + 1] = {NAME = 'firetouchinterests / touchinterests [name]', DESC = '使用游戏中的所有接触兴趣或使用可选名称'}--/？
CMDs[#CMDs + 1] = {NAME = 'noproximitypromptlimits / nopplimits', DESC = '将所有邻近提示MaxActivationDistance设置为math.huge'}--/？
CMDs[#CMDs + 1] = {NAME = 'fireproximityprompts / firepp [name]', DESC = '使用游戏中的所有接近提示或使用可选名称'}--/？
CMDs[#CMDs + 1] = {NAME = 'instantproximityprompts / instantpp', DESC = '禁用近程提示的冷却'}--/？
CMDs[#CMDs + 1] = {NAME = 'uninstantproximityprompts / uninstantpp', DESC = '撤消冷却移除'}--/？
CMDs[#CMDs + 1] = {NAME = 'tpunanchored / tpua [player]', DESC = '将未锁定的物体传送给玩家'}
CMDs[#CMDs + 1] = {NAME = 'animsunanchored / freezeua', DESC = '冻结未锁定的零件'}
CMDs[#CMDs + 1] = {NAME = 'thawunanchored / thawua / unfreezeua', DESC = '解冻未固定的部分(这不多此一举吗)'}
CMDs[#CMDs + 1] = {NAME = 'removeterrain / rterrain / noterrain', DESC = '移除所有地形'}
CMDs[#CMDs + 1] = {NAME = 'clearnilinstances / nonilinstances / cni', DESC = '删除nil实例'}--/？
CMDs[#CMDs + 1] = {NAME = 'destroyheight / dh [num]', DESC = '设置掉落的零件破坏高度'}--/？
CMDs[#CMDs + 1] = {NAME = 'fakeout', DESC = 'Tp到虚空然后回来(可以杀死依附你的人)'}
CMDs[#CMDs + 1] = {NAME = 'antivoid', DESC = '通过向上发射来防止你坠入虚空'}
CMDs[#CMDs + 1] = {NAME = 'unantivoid / noantivoid', DESC = '禁用 antivoid'}
CMDs[#CMDs + 1] = {NAME = '//照明篇//', DESC = '有什么问题请去我评论区评论,我都会看的(私聊也行)'}
CMDs[#CMDs + 1] = {NAME = 'fullbright / fb (CLIENT)', DESC = '使地图更亮/更明显 (非常推荐'}
CMDs[#CMDs + 1] = {NAME = 'loopfullbright / loopfb (CLIENT)', DESC = '使地图更亮/更可见，但呈环状'}--/？
CMDs[#CMDs + 1] = {NAME = 'unloopfullbright / unloopfb', DESC = '禁用 fullbright'}
CMDs[#CMDs + 1] = {NAME = 'ambient [num] [num] [num] (CLIENT)', DESC = '更改环境'}--/？
CMDs[#CMDs + 1] = {NAME = 'day (CLIENT)', DESC = '让你客户端时间为白天'}
CMDs[#CMDs + 1] = {NAME = 'night (CLIENT)', DESC = '让你客户端时间为黑天'}
CMDs[#CMDs + 1] = {NAME = 'nofog (CLIENT)', DESC = '移除场景中的雾气'}
CMDs[#CMDs + 1] = {NAME = 'brightness [num] (CLIENT)', DESC = '更改灯光亮度'}
CMDs[#CMDs + 1] = {NAME = 'globalshadows / gshadows (CLIENT)', DESC = '启用全局阴影'}
CMDs[#CMDs + 1] = {NAME = 'noglobalshadows / nogshadows (CLIENT)', DESC = '禁用全局阴影'}
CMDs[#CMDs + 1] = {NAME = 'restorelighting / rlighting', DESC = '复原照明属性'}
CMDs[#CMDs + 1] = {NAME = 'light [radius] [brightness] (CLIENT)', DESC = '给你人物动态光源'}
CMDs[#CMDs + 1] = {NAME = 'nolight / unlight', DESC = '移除动态光源'}
CMDs[#CMDs + 1] = {NAME = '//杂项//', DESC = '测试脚本可以去https://www.roblox.com/games/9004888750'}
CMDs[#CMDs + 1] = {NAME = 'inspect / examine [player]', DESC = '打开某人检查菜单'}
CMDs[#CMDs + 1] = {NAME = 'age [player]', DESC = '告诉你那个玩家注册时选择的年龄(基本都是瞎填的)'}
CMDs[#CMDs + 1] = {NAME = 'chatage [player]', DESC = '在聊天栏聊玩家的年龄'}
CMDs[#CMDs + 1] = {NAME = 'joindate / jd [player]', DESC = '告诉你玩家加入Roblox的日期'}
CMDs[#CMDs + 1] = {NAME = 'chatjoindate / cjd [player]', DESC = '在聊天栏聊玩家加入Roblox的日期'}
CMDs[#CMDs + 1] = {NAME = 'copyname / copyuser [player]', DESC = '将玩家的完整用户名复制到你的剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'userid / id [player]', DESC = '通知你玩家的用户名'}
CMDs[#CMDs + 1] = {NAME = 'copyuserid / copyid [player]', DESC = '将玩家的用户名复制到你的剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'appearanceid / aid [player]', DESC = '通知玩家外观ID'}
CMDs[#CMDs + 1] = {NAME = 'copyappearanceid / caid [player]', DESC = '将玩家的外貌ID复制到剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'bang [player] [speed]', DESC = '掀飞指定玩家owo'}
CMDs[#CMDs + 1] = {NAME = 'unbang', DESC = '取消掀飞他人uwu'}
CMDs[#CMDs + 1] = {NAME = 'carpet [player]', DESC = '成为某人的地毯'}
CMDs[#CMDs + 1] = {NAME = 'uncarpet', DESC = '取消成为某人的地毯'}
CMDs[#CMDs + 1] = {NAME = 'friend [player]', DESC = '向指定玩家发送好友请求'}
CMDs[#CMDs + 1] = {NAME = 'unfriend [player]', DESC = '取消向指定玩家发送好友请求'}
CMDs[#CMDs + 1] = {NAME = 'headsit [player]', DESC = '坐在某人头上'}
CMDs[#CMDs + 1] = {NAME = 'walkto / follow [player]', DESC = '跟随指定玩家'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalkto / pathfindfollow [player]', DESC = '使用寻路跟随玩家'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalktowaypoint / pathfindwalktowp [waypoint]', DESC = '使用寻路功能走到一个航路点'}
CMDs[#CMDs + 1] = {NAME = 'unwalkto / unfollow', DESC = '停止跟随指定玩家'}
CMDs[#CMDs + 1] = {NAME = 'orbit [player] [speed] [distance]', DESC = '让你的角色以可选的速度和距离围绕一个玩家旋转'}
CMDs[#CMDs + 1] = {NAME = 'unorbit', DESC = '禁用环绕'}
CMDs[#CMDs + 1] = {NAME = 'stareat / stare [player]', DESC = '盯着/看着一名运动员'}
CMDs[#CMDs + 1] = {NAME = 'unstareat / unstare [player]', DESC = '禁用stareat'}
CMDs[#CMDs + 1] = {NAME = 'rolewatch [group id] [role name]', DESC = '如果有人从指定的群组加入服务器，则发出通知'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchstop / unrolewatch', DESC = '禁用 Rolewatch'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchleave', DESC = '切换如果有人加入服务器你自动退出游戏'}
CMDs[#CMDs + 1] = {NAME = 'staffwatch', DESC = '通知是否有开发者加入服务器'}
CMDs[#CMDs + 1] = {NAME = 'unstaffwatch', DESC = '禁用开发者进入通知'}
CMDs[#CMDs + 1] = {NAME = 'attach [player] (TOOL)', DESC = '将你连接到一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'kill [player] (TOOL)', DESC = '杀死一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fastkill [player] (TOOL)', DESC = '杀死一个玩家(不太可靠)(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'handlekill / hkill [player] (TOOL)', DESC = '使用工具伤害杀死玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'bring [player] (TOOL)', DESC = '带来一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fastbring [player] (TOOL)', DESC = '带来一个玩家(不太可靠)(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'teleport / tp [player] [player] (TOOL)', DESC = '将一个玩家传送到另一个玩家(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fastteleport / fasttp [player] [player] (TOOL)', DESC = '将一个玩家传送到另一个玩家(不太可靠)(你需要一个工具)'}
CMDs[#CMDs + 1] = {NAME = 'fling', DESC = '甩飞你碰到的任何人'}
CMDs[#CMDs + 1] = {NAME = 'unfling', DESC = '禁用fling指令'}
CMDs[#CMDs + 1] = {NAME = 'flyfling', DESC = '低配版invisfling命令，能被看到'}
CMDs[#CMDs + 1] = {NAME = 'unflyfling', DESC = '禁用 flyfling指令'}
CMDs[#CMDs + 1] = {NAME = 'walkfling', DESC = '和fling指令差不多，但没有旋转'}
CMDs[#CMDs + 1] = {NAME = 'unwalkfling / nowalkfling', DESC = '禁用 walkfling'}
CMDs[#CMDs + 1] = {NAME = 'invisfling', DESC = '启用隐形陀螺'}
CMDs[#CMDs + 1] = {NAME = 'antifling', DESC = '禁用玩家碰撞以防止您被甩出'}
CMDs[#CMDs + 1] = {NAME = 'unantifling', DESC = '禁用防陀螺'}
CMDs[#CMDs + 1] = {NAME = 'loopoof', DESC = '循环每个人的角色声音(每个人都能听到)'}--/？
CMDs[#CMDs + 1] = {NAME = 'unloopoof', DESC = '停止oof混乱'}--/？
CMDs[#CMDs + 1] = {NAME = 'muteboombox [player]', DESC = '将某人的音箱静音'}--/？
CMDs[#CMDs + 1] = {NAME = 'unmuteboombox [player]', DESC = '取消某人的音箱静音'}--/？
CMDs[#CMDs + 1] = {NAME = 'hitbox [player] [size]', DESC = '放大玩家的hitbox(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'headsize [player] [size]', DESC = '更改玩家的头部大小(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = '//人物篇//', DESC = '测试脚本可在ROBLOX搜开放世界4M大作('}
CMDs[#CMDs + 1] = {NAME = 'reset', DESC = '正常重置角色'}
CMDs[#CMDs + 1] = {NAME = 'respawn', DESC = '重生你自己'}
CMDs[#CMDs + 1] = {NAME = 'refresh / re', DESC = '重生并让你回到原来的位置'}
CMDs[#CMDs + 1] = {NAME = 'god', DESC = '让你在某些游戏中不可被杀死'}
CMDs[#CMDs + 1] = {NAME = 'invisible / invis', DESC = '让其他玩家看不见你'}
CMDs[#CMDs + 1] = {NAME = 'visible / vis', DESC = '使您对其他玩家可见'}
CMDs[#CMDs + 1] = {NAME = 'toolinvisible / toolinvis / tinvis', DESC = '让其他玩家看不见你，并且可以使用工具'}
CMDs[#CMDs + 1] = {NAME = 'speed / ws / walkspeed [num]', DESC = '更改你的移速'}
CMDs[#CMDs + 1] = {NAME = 'spoofspeed / spoofws [num]', DESC = '在客户端上伪造你的移动速度'}--/？
CMDs[#CMDs + 1] = {NAME = 'loopspeed / loopws [num]', DESC = '循环您的步行速度'}--/？
CMDs[#CMDs + 1] = {NAME = 'unloopspeed / unloopws', DESC = '关闭循环速度'}
CMDs[#CMDs + 1] = {NAME = 'hipheight / hheight [num]', DESC = '调节臀部高度'}--/？
CMDs[#CMDs + 1] = {NAME = 'jumppower / jpower / jp [num]', DESC = '改变玩家的跳跃高度'}
CMDs[#CMDs + 1] = {NAME = 'spoofjumppower / spoofjp [num]', DESC = '在客户端上欺骗你的跳跃能力'}--/？
CMDs[#CMDs + 1] = {NAME = 'loopjumppower / loopjp [num]', DESC = '循环你的跳跃高度'}
CMDs[#CMDs + 1] = {NAME = 'unloopjumppower / unloopjp', DESC = '关闭 loopjumppower'}--/？
CMDs[#CMDs + 1] = {NAME = 'maxslopeangle / msa [num]', DESC = '调整最大倾斜角度'}--/？
CMDs[#CMDs + 1] = {NAME = 'gravity / grav [num] (CLIENT)', DESC = '改变你的重力'}
CMDs[#CMDs + 1] = {NAME = 'sit', DESC = '让你坐下'}
CMDs[#CMDs + 1] = {NAME = 'lay / laydown', DESC = '让你躺下'}
CMDs[#CMDs + 1] = {NAME = 'sitwalk', DESC = '保持坐下的动作行走'}
CMDs[#CMDs + 1] = {NAME = 'nosit', DESC = '防止您的角色坐着'}
CMDs[#CMDs + 1] = {NAME = 'unnosit', DESC = '禁用 nosit'}
CMDs[#CMDs + 1] = {NAME = 'jump', DESC = '让你跳一下'}
CMDs[#CMDs + 1] = {NAME = 'infinitejump / infjump', DESC = '让你可以一直跳'}
CMDs[#CMDs + 1] = {NAME = 'uninfinitejump / uninfjump', DESC = '禁用无限跳跃'}
CMDs[#CMDs + 1] = {NAME = 'flyjump', DESC = '按住跳跃来飞行'}
CMDs[#CMDs + 1] = {NAME = 'unflyjump', DESC = '禁用飞行跳跃'}
CMDs[#CMDs + 1] = {NAME = 'autojump / ajump', DESC = '碰到一个物体时自动跳跃'}
CMDs[#CMDs + 1] = {NAME = 'unautojump / unajump', DESC = '禁用自动跳跃'}
CMDs[#CMDs + 1] = {NAME = 'edgejump / ejump', DESC = '当到达对象边缘时自动跳转'}
CMDs[#CMDs + 1] = {NAME = 'unedgejump / unejump', DESC = '关闭edgejump'}
CMDs[#CMDs + 1] = {NAME = 'platformstand / stun', DESC = '启用平台站立'}
CMDs[#CMDs + 1] = {NAME = 'unplatformstand / unstun', DESC = '禁用 平台站立'}
CMDs[#CMDs + 1] = {NAME = 'norotate / noautorotate', DESC = '禁用自动旋转'}
CMDs[#CMDs + 1] = {NAME = 'unnorotate / autorotate', DESC = '启用自动旋转'}
CMDs[#CMDs + 1] = {NAME = 'enablestate [StateType]', DESC = '启用人形状态类型'}
CMDs[#CMDs + 1] = {NAME = 'disablestate [StateType]', DESC = '禁用人形状态类型'}
CMDs[#CMDs + 1] = {NAME = 'team [team name] (CLIENT)', DESC = '改变你的团队。欺骗本地脚本.'}
CMDs[#CMDs + 1] = {NAME = 'nobillboardgui / nobgui / noname', DESC = '从你的玩家身上移除广告牌和桌面图形界面(例如咖啡馆里的名字图形界面)'}
CMDs[#CMDs + 1] = {NAME = 'loopnobgui / loopnoname', DESC = '循环从你的玩家身上移除广告牌和表面图形界面(比如咖啡馆里的名字图形界面)'}
CMDs[#CMDs + 1] = {NAME = 'unloopnobgui / unloopnoname', DESC = '禁用 loopnobgui'}
CMDs[#CMDs + 1] = {NAME = 'noarms', DESC = '移除你的胳膊'}
CMDs[#CMDs + 1] = {NAME = 'nolegs', DESC = '移除你的腿'}
CMDs[#CMDs + 1] = {NAME = 'nolimbs', DESC = '移除你的四肢'}
CMDs[#CMDs + 1] = {NAME = 'naked (CLIENT)', DESC = '脱掉你的衣服'}
CMDs[#CMDs + 1] = {NAME = 'noface / removeface', DESC = '去掉你的脸'}
CMDs[#CMDs + 1] = {NAME = 'blockhead', DESC = '把你的头变成一块积木'}
CMDs[#CMDs + 1] = {NAME = 'blockhats', DESC = '把你的帽子变成积木'}
CMDs[#CMDs + 1] = {NAME = 'blocktool', DESC = '将当前选定的工具变成块'}
CMDs[#CMDs + 1] = {NAME = 'creeper', DESC = '让你看起来像个我的世界中的苦力怕'}
CMDs[#CMDs + 1] = {NAME = 'drophats', DESC = '扔掉你的帽子'}
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats / rhats', DESC = '删除你的帽子'}
CMDs[#CMDs + 1] = {NAME = 'hatspin / spinhats', DESC = '旋转您的角色配件'}
CMDs[#CMDs + 1] = {NAME = 'unhatspin / unspinhats', DESC = '禁用 spinhats'}
CMDs[#CMDs + 1] = {NAME = 'clearhats / cleanhats', DESC = '清除地图中的帽子'}
CMDs[#CMDs + 1] = {NAME = 'chardelete / cd [instance name]', DESC = '从角色中移除具有特定名称的任何部分'}
CMDs[#CMDs + 1] = {NAME = 'chardeleteclass / cdc [class name]', DESC = '从角色中移除具有特定名称的任何部分'}
CMDs[#CMDs + 1] = {NAME = 'deletevelocity / dv / removeforces', DESC = '移除角色中的任何速度/力实例'}
CMDs[#CMDs + 1] = {NAME = 'weaken [num]', DESC = '让你的角色不那么密集'}
CMDs[#CMDs + 1] = {NAME = 'unweaken', DESC = '将角色的自定义物理属性设置为默认值'}
CMDs[#CMDs + 1] = {NAME = 'strengthen [num]', DESC = '使您的角色更加密集(自定义物理属性)'}
CMDs[#CMDs + 1] = {NAME = 'unstrengthen', DESC = '将角色的自定义物理属性设置为默认值'}
CMDs[#CMDs + 1] = {NAME = 'breakvelocity', DESC = '将角色速度设定为0'}
CMDs[#CMDs + 1] = {NAME = 'spin [speed]', DESC = '让你转起来'}
CMDs[#CMDs + 1] = {NAME = 'unspin', DESC = '禁用旋转'}
CMDs[#CMDs + 1] = {NAME = 'split', DESC = '腰斩你自己'}
CMDs[#CMDs + 1] = {NAME = 'nilchar', DESC = '将角色的母物体设置为无'}
CMDs[#CMDs + 1] = {NAME = 'unnilchar / nonilchar', DESC = '将角色的母物体设置为地图'}
CMDs[#CMDs + 1] = {NAME = 'noroot / removeroot / rroot', DESC = '移除角色躯干的控制'}
CMDs[#CMDs + 1] = {NAME = 'replaceroot', DESC = '修复角色躯干的控制'}
CMDs[#CMDs + 1] = {NAME = 'clearcharappearance / clearchar / clrchar', DESC = '移除所有附件、衬衫、裤子、角色网格和身体颜色'}
CMDs[#CMDs + 1] = {NAME = '//动画篇//', DESC = '只是分割线'}
CMDs[#CMDs + 1] = {NAME = 'animation / anim [ID] [speed]', DESC = '使您的角色执行动画(必须通过roblox进行复制)'}
CMDs[#CMDs + 1] = {NAME = 'dance', DESC = '让你跳舞'}
CMDs[#CMDs + 1] = {NAME = 'undance', DESC = '停止跳舞'}
CMDs[#CMDs + 1] = {NAME = 'spasm', DESC = '让你变得疯狂'}
CMDs[#CMDs + 1] = {NAME = 'unspasm', DESC = '停止spasm'}
CMDs[#CMDs + 1] = {NAME = 'headthrow', DESC = '让你把头抬起来'}
CMDs[#CMDs + 1] = {NAME = 'noanim', DESC = '禁用您的动画'}
CMDs[#CMDs + 1] = {NAME = 'reanim', DESC = '恢复动画'}
CMDs[#CMDs + 1] = {NAME = 'animspeed [num]', DESC = '更改当前动画的速度'}
CMDs[#CMDs + 1] = {NAME = 'copyanimation / copyanim / copyemote [player]', DESC = '复制别人的动画'}
CMDs[#CMDs + 1] = {NAME = 'copyanimationid / copyanimid / copyemoteid [player]', DESC = '将你或其他人的动画id复制到你的剪贴板'}
CMDs[#CMDs + 1] = {NAME = 'loopanimation / loopanim', DESC = '循环播放当前动画'}
CMDs[#CMDs + 1] = {NAME = 'stopanimations / stopanims', DESC = '停止播放动画'}
CMDs[#CMDs + 1] = {NAME = 'refreshanimations / refreshanims', DESC = '刷新动画'}
CMDs[#CMDs + 1] = {NAME = 'allowcustomanim / allowcustomanimations', DESC = '允许您使用自定义动画包'}
CMDs[#CMDs + 1] = {NAME = 'unallowcustomanim / unallowcustomanimations', DESC = '不允许您使用自定义动画包'}
CMDs[#CMDs + 1] = {NAME = '//按键篇//', DESC = '只是分割线'}
CMDs[#CMDs + 1] = {NAME = 'autoclick [click delay] [release delay]', DESC = '自动点击'}
CMDs[#CMDs + 1] = {NAME = 'unautoclick / noautoclick', DESC = '禁用自动点击'}
CMDs[#CMDs + 1] = {NAME = 'autokeypress [key] [down delay] [up delay]', DESC = '在设定的延迟时间内自动按按键'}
CMDs[#CMDs + 1] = {NAME = 'unautokeypress', DESC = '停止自动按按键'}
CMDs[#CMDs + 1] = {NAME = 'hovername', DESC = '当你的鼠标停留在玩家身上时显示他们的用户名'}
CMDs[#CMDs + 1] = {NAME = 'unhovername / nohovername', DESC = '禁用鼠标放在他人身上时显示用户名'}
CMDs[#CMDs + 1] = {NAME = 'mousesensitivity / ms [0-10]', DESC = '设置鼠标灵敏度(影响第一人称和右键拖动)(默认值为1)'}
CMDs[#CMDs + 1] = {NAME = 'clickdelete', DESC = '去设置中绑定按键为删除'}
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = '去设置中绑定按键为传送'}
CMDs[#CMDs + 1] = {NAME = 'mouseteleport / mousetp', DESC = '将角色传送到鼠标.(建议绑个按键)'}
CMDs[#CMDs + 1] = {NAME = '//工具篇//', DESC = '只是分割线'}
CMDs[#CMDs + 1] = {NAME = 'tools', DESC = '从Replicated Storage和Lighting复制工具'}--/？
CMDs[#CMDs + 1] = {NAME = 'notools / removetools / deletetools', DESC = '从角色和背包中移除工具'}
CMDs[#CMDs + 1] = {NAME = 'deleteselectedtool / dst', DESC = '删除当前选定的所有工具'}
CMDs[#CMDs + 1] = {NAME = 'grabtools', DESC = '全图范围自动获取掉落的工具(大部分游戏不可用/俺拾的嘞)'}
CMDs[#CMDs + 1] = {NAME = 'ungrabtools / nograbtools', DESC = '禁用自动拾取'}
CMDs[#CMDs + 1] = {NAME = 'copytools [player] (CLIENT)', DESC = '复制玩家工具'}
CMDs[#CMDs + 1] = {NAME = 'dupetools / clonetools [num]', DESC = '多次复制您的库存工具'}
CMDs[#CMDs + 1] = {NAME = 'givetool / givetools', DESC = '使用附加方法将您持有的所有工具提供给[玩家].'}
CMDs[#CMDs + 1] = {NAME = 'droptools', DESC = '放下你的工具'}
CMDs[#CMDs + 1] = {NAME = 'droppabletools', DESC = '使您的工具可丢弃'}
CMDs[#CMDs + 1] = {NAME = 'equiptools', DESC = '一次装备你库存中的所有工具'}
CMDs[#CMDs + 1] = {NAME = 'unequiptools', DESC = '立即取消装备您当前持有的每个工具'}
CMDs[#CMDs + 1] = {NAME = 'removespecifictool [name]', DESC = '自动从库存中删除特定工具'}
CMDs[#CMDs + 1] = {NAME = 'unremovespecifictool [name]', DESC = '停止从库存中移除特定工具'}
CMDs[#CMDs + 1] = {NAME = 'clearremovespecifictool', DESC = '停止从库存中删除所有特定工具'}
CMDs[#CMDs + 1] = {NAME = 'reach [num]', DESC = '增加所持工具的命中率'}
CMDs[#CMDs + 1] = {NAME = 'boxreach [num]', DESC = '将所持工具的击球框增加为箱形'}
CMDs[#CMDs + 1] = {NAME = 'unreach / noreach', DESC = '关闭reach'}
CMDs[#CMDs + 1] = {NAME = 'grippos [X Y Z]', DESC = '更改当前的工具夹点位置'}
CMDs[#CMDs + 1] = {NAME = 'usetools [ammount] [delay]', DESC = '同时激活背包中的所有工具'}
CMDs[#CMDs + 1] = {NAME = '//指令别名篇//', DESC = '只是分割线'}
CMDs[#CMDs + 1] = {NAME = 'addalias [cmd] [alias]', DESC = '向指令添加别名'}
CMDs[#CMDs + 1] = {NAME = 'removealias [alias]', DESC = '删除自定义别名'}
CMDs[#CMDs + 1] = {NAME = 'clraliases', DESC = '删除所有自定义别名'}
CMDs[#CMDs + 1] = {NAME = '//插件篇//', DESC = '只是分割线'}
CMDs[#CMDs + 1] = {NAME = 'addplugin / plugin [name]', DESC = '通过命令添加插件'}
CMDs[#CMDs + 1] = {NAME = 'removeplugin / deleteplugin [name]', DESC = '通过命令删除插件'}
CMDs[#CMDs + 1] = {NAME = 'reloadplugin [name]', DESC = '重新加载插件'}
CMDs[#CMDs + 1] = {NAME = '//杂项//', DESC = '只是分割线'}
CMDs[#CMDs + 1] = {NAME = 'breakloops / break (cmd loops)', DESC = '停止任何cmd循环(;100^1^cmd)'}
CMDs[#CMDs + 1] = {NAME = 'removecmd / deletecmd', DESC = '删除命令，直到管理员重新加载'}
CMDs[#CMDs + 1] = {NAME = 'tpwalk / teleportwalk [num]', DESC = '传送你到你的移动方向(理解为倍速移动即可)'}
CMDs[#CMDs + 1] = {NAME = 'untpwalk / unteleportwalk', DESC = '取消tpwalk'}
CMDs[#CMDs + 1] = {NAME = 'notifyping / ping', DESC = '告诉你当前的ping'}
CMDs[#CMDs + 1] = {NAME = 'trip', DESC = '让你的角色向前倒下'}
CMDs[#CMDs + 1] = {NAME = 'norender', DESC = '禁用3d渲染以减少客户端使用的CPU数量'}
CMDs[#CMDs + 1] = {NAME = 'render', DESC = '启用3d渲染'}
CMDs[#CMDs + 1] = {NAME = 'use2022materials / 2022materials', DESC = '启用2022种材质纹理'}
CMDs[#CMDs + 1] = {NAME = 'unuse2022materials / un2022materials', DESC = '禁用2022材质纹理'}
CMDs[#CMDs + 1] = {NAME = 'promptr6', DESC = '提示游戏将你的人物类型切换到R6'}
CMDs[#CMDs + 1] = {NAME = 'promptr15', DESC = '提示游戏将你的人物类型切换到R15'}
CMDs[#CMDs + 1] = {NAME = 'wallwalk / walkonwalls', DESC = '在墙上走(github脚本)'}
CMDs[#CMDs + 1] = {NAME = 'removeads / adblock', DESC = '自动删除广告牌'}
wait()
...
function unkeybind(cmd,key)
	...
	if key == 'RightClick' or key == 'LeftClick' then
		notify('按键绑定已更新','解除 '..key..' 绑定的 '..cmd)
	else
		notify('按键绑定已更新','解除 '..key:sub(14)..' 绑定的 '..cmd)
	end
end
...
Add_2.MouseButton1Click:Connect(function()
	if keySelected then
		if string.find(Cmdbar_2.Text, "\\\\") or string.find(Cmdbar_3.Text, "\\\\") then
			notify('按键错误','仅使用一个反斜杠将多个命令键绑定到一个键绑定或命令中')
		else
			...
			if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
				notify('按键绑定更新','绑定 '..keyPressed..' 到 '..Cmdbar_2.Text..(newToggle and " / "..Cmdbar_3.Text or ""))
			else
				notify('按键绑定更新','绑定 '..keyPressed:sub(14)..' to '..Cmdbar_2.Text..(newToggle and " / "..Cmdbar_3.Text or ""))
			end
		end
	end
end)
...
ClickTP.Select.MouseButton1Click:Connect(function()
	if keySelected then
		...
		updatesaves()
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			notify('按键绑定更新','绑定 '..keyPressed..' 来TP')
		else
			notify('按键绑定更新','绑定 '..keyPressed:sub(14)..' 来TP')
		end
	end
end)
...
ClickDelete.Select.MouseButton1Click:Connect(function()
	if keySelected then
		...
		updatesaves()
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			notify('按键绑定更新','绑定 '..keyPressed..' 来删除')
		else
			notify('按键绑定更新','绑定 '..keyPressed:sub(14)..' 来删除')
		end
	end
end)
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'iy_fe.iy' or name == 'iy_fe' then
		...
		if file then
			...
			notify('插件错误','找不到文件 "'..fileName..'". 文件是否在正确的文件夹中?')
		end
	end
end
...
function LoadPlugin(val,startup)
	...
	if plugin ~= nil then
		if not startup then
			notify('加载插件',"名字: "..plugin["PluginName"].."\n".."描述: "..plugin["PluginDescription"])
		end
		addcmdtext('',val)
...
Plugins.MouseButton1Click:Connect(function()
	if writefileExploit() then
		...
		notify('不兼容注入器','您的注入器无法使用插件（缺少读/写文件）')
	end
end)
...
addcmd('addalias',{},function(args, speaker)
	...
	for i,v in pairs(cmds) do
		if v.NAME:lower()==cmd or FindInTable(v.ALIAS,cmd) then
			...
			notify('别名已修改',"添加 "..alias.." 作为 "..cmd "的别名")
			updatesaves()
			refreshaliases()
			break
		end
...
addcmd('removealias',{},function(args, speaker)
	...
	if customAlias[alias] then
		...
		notify('别名已修改',"已删除 "..alias.." 的别名 "..cmd)
		updatesaves()
		refreshaliases()
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if everyClipboard then
		...
		notify('Discord邀请', '已复制至粘贴板!\ndiscord.gg/dYHag43eeU')
	else
		notify('Discord邀请', 'discord.gg/dYHag43eeU')
	end
	if httprequest then
		httprequest({
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		...
		notify('不兼容注入器','您的注入器不支持此命令（缺少queue_on_teleport）')
	end
end)
...
addcmd('serverinfo',{'info','sinfo'},function(args, speaker)
	...
	task.spawn(function()
		...
		SINFOGUI.name.Text = "场景名字: " .. Asset.Name
		SINFOGUI.playerid.Text = "玩家ID: " ..speaker.UserId
		SINFOGUI.maxplayers.Text = Players.MaxPlayers.. " 玩家满人"
		SINFOGUI.placeid.Text = "场景ID: " ..PlaceId
		...
		repeat
			...
			SINFOGUI.players.Text = #players.. " 个玩家"
...
addcmd('notifyjobid',{},function(args, speaker)
	notify('JobId / 场景Id',JobId..' / '..PlaceId)
end)
...
addcmd("serverhop", {"shop"}, function(args, speaker)
	...
	if httprequest then
		...
		if #servers > 0 then
			...
			return notify("随机服务器", "找不到服务器.")
		end
	else
		notify("不兼容注入器", "您的注入器不支持此命令（缺少请求）")
	end
end)
	...
	function ToServer(User,Place)	
		...
		if not pcall(function()
				...
				if not FoundUser then
					notify('加入错误','Username/UserID 不存在')
				else
					notify('加入玩家','加载服务器中.请稍等.')
		...
		then
			if retries < 3 then
				...
				notify('加入错误','尝试加入时出错。正在重试 '..retries..'/3.')
				ToServer(User,Place)
			else
				notify('加入错误','尝试加入时出错.')
			end
...
addcmd('setwaypoint',{'swp','setwp','spos','saveposition','savepos'},function(args, speaker)
	...
	if getRoot(speaker.Character) then
		notify('修改的航点',"创建航路点: "..getstring(1))
...
addcmd('hideiy',{},function(args, speaker)
	...
	minimizeNum = 0
	minimizeHolder()
	if not (args[1] and tostring(args[1]) == 'nonotify') then notify('IY隐藏','你可以按前缀键访问命令栏默认为;键') end
end)
...
addcmd("savegame", {"saveplace"}, function(args, speaker)
	if saveinstance then
		notify("加载中", "正在下载游戏。这需要一段时间")
		saveinstance()
		notify("游戏已保存", "保存到注入器文件夹中的workspace文件夹.")
	else
		notify("不兼容注入器", "您的注入器不支持此命令（缺少保存信息）")
	end
end)
...
addcmd('clientantikick',{'antikick'},function(args, speaker)
	if not hookmetamethod then 
		return notify('不兼容注入器','您的注入器不支持此命令(缺少hookmetamethod)')
	end
	local LocalPlayer = Players.LocalPlayer
	local oldhmmi
	local oldhmmnc
	...
	notify('客户端防踢','客户端防踢现已激活（仅对本地脚本有效)')
end)
...
addcmd('clientantiteleport',{'antiteleport'},function(args, speaker)
	...
	notify('客户端防TP','客户端防传送现已激活（仅对本地脚本传送有效）')
end)

addcmd('allowrejoin',{'allowrj'},function(args, speaker)
	if args[1] and args[1] == 'false' then
		allow_rj = false
		notify('客户端防TP','允许重新加入已禁用')
	else
		allow_rj = true
		notify('客户端反TP','允许重新加入已启用')
	end
end)
...
addcmd('setfpscap', {'fpscap', 'maxfps'}, function(args, speaker)
	if setfpscap and type(setfpscap) == "function" then
		...
		elseif num > 0 then
			...
			return notify('无效参数', "请提供一个大于0的数字或无.")
		end
	else
		return notify('不兼容注入器', '您的注入器不支持此命令（缺少setfpscap）')
	end
end)
...
addcmd('esp',{},function(args, speaker)
	if not CHMSenabled then
		...
		notify('ESP','使用esp前请禁用chams(输入nochams)')
	end
end)
...
addcmd('chams',{},function(args, speaker)
	if not ESPenabled then
		...
		notify('Chams','在使用chams之前请禁用ESP(输入noesp)')
	end
end)
...
addcmd('noclipcam', {'nccam'}, function(args, speaker)
	...
	if not sc or not getgc or not gc then
		return notify('不兼容注入器', '您的注入器不支持此命令（缺少setconstant、getconstants或getgc）')
	end
...
addcmd('deleteclass',{'removeclass','deleteclassname','removeclassname','dc'},function(args, speaker)
	...
	notify('物品删除','已删除具有 ' ..getstring(1) '类名称的零件')
end)
...
addcmd('chardeleteclass',{'charremoveclass','chardeleteclassname','charremoveclassname','cdc'},function(args, speaker)
	...
	notify('物品删除','已删除具有 ' ..getstring(1)'类名的零件')
end)
...
addcmd('antiafk',{'antiidle'},function(args, speaker)
	...
	if not (args[1] and tostring(args[1]) == 'nonotify') then notify('防怠速','防怠速已启用') end
end)
...
addcmd('joindate',{'jd'},function(args, speaker)
	...
	notify('加入日期 (顺序:月/日/年)',table.concat(dates, ',\n'))
end)
...
addcmd('setcreatorid',{'setcreator'},function(args, speaker)
	if game.CreatorType == Enum.CreatorType.User then
		...
		notify('设置ID','将用户名设置为 '..game.CreatorId)
	elseif game.CreatorType == Enum.CreatorType.Group then
		local OwnerID = GroupService:GetGroupInfoAsync(game.CreatorId).Owner.Id
		speaker.UserId = OwnerID
		notify('设置ID','设置用户名为 '..OwnerID)
	end
end)
...
addcmd('2022materials',{'use2022materials'},function(args, speaker)
	if sethidden then
		...
		notify('不兼容注入器','您的漏洞利用不支持此命令（缺少sethiddenproperty）')
	end
end)
...
addcmd('un2022materials',{'unuse2022materials'},function(args, speaker)
	if sethidden then
		...
		notify('不兼容注入器','您的注入器不支持此命令（缺少sethiddenproperty）')
	end
end)
...
addcmd("orbit", {}, function(args, speaker)
	...
	if target and target.Character and getRoot(target.Character) and root and humanoid then
		...
		notify("围绕", "开始绕 " .. formatUsername(target))
	end
end)
...
addcmd("unorbit", {}, function(args, speaker)
	...
	if args[1] ~= "nonotify" then notify("围绕", "已停止绕玩家运行") end
end)
...
addcmd('muteboombox',{},function(args, speaker)
	if not notifiedRespectFiltering and SoundService.RespectFilteringEnabled then notifiedRespectFiltering = true notify('静音启动/？','禁音已启动（该命令仍将工作，但可能仅在客户端)') end
	local players = getPlayer(args[1], speaker)
	if players ~= nil then
		for i,v in pairs(players) do
			task.spawn(function()
...
addcmd('clickteleport',{},function(args, speaker)
	if speaker == Players.LocalPlayer then
		notify('点击 TP','前往设置>按键>添加进行设置，单击tp')
	end
end)
...
addcmd('clickdelete',{},function(args, speaker)
	if speaker == Players.LocalPlayer then
		notify('单击删除','前往设置>按键>添加进行设置，单击删除')
	end
end)
...
addcmd('spoofspeed',{'spoofws','spoofwalkspeed'},function(args, speaker)
	if args[1] and isNumber(args[1]) then
		if hookmetamethod then
			...
			notify('不兼容注入器','您的注入器不支持此命令（缺少hookmetamethod）')
		end
	end
end)
...
addcmd('spoofjumppower',{'spoofjp'},function(args, speaker)
	if args[1] and isNumber(args[1]) then
		if hookmetamethod then
			...
			notify('不兼容注入器','您的注入器不支持此命令(缺少 hookmetamethod)')
		end
	end
end)
...
addcmd('tools',{'gears'},function(args, speaker)
	...
	notify('工具','复制自Replicated Storage and Lighting的工具')
end)
...
addcmd('fireclickdetectors',{'firecd','firecds'}, function(args, speaker)
	if fireclickdetector then
		...
		notify("不兼容注入器", "您的注入器不支持此命令(缺少 fireclickdetector)")
	end
end)
...
addcmd('fireproximityprompts',{'firepp'},function(args, speaker)
	if fireproximityprompt then
		...
		notify("不兼容注入器", "您的注入器不支持此命令(缺少 fireproximityprompt)")
	end
end)
...
addcmd('spawnpoint',{'spawn'},function(args, speaker)
	...
	notify('出生点','出生点创造于 '..tostring(spawnpos))
end)
...
addcmd('clearhats',{'cleanhats'},function(args, speaker)
	if firetouchinterest then
		...
		notify("不兼容注入器","您的注入器不支持此命令(缺少 firetouchinterest)")
	end
end)
...
addcmd("antichatlogs", {"antichatlogger"}, function(args, speaker)
	...
	notify("防聊天记录", MessagePosted and "Enabled" or "Failed to enable antichatlogs")
end)
...
function attach(speaker,target)
	if tools(speaker) then
		...
		notify('需要工具','你需要在库存中有一个工具才能使用此命令')
	end
end
...
addcmd('handlekill', {'hkill'}, function(args, speaker)
	if not firetouchinterest then
		return notify('不兼容注入器', '您的注入器不支持此命令(缺少 firetouchinterest)')
	end
	local RS = RunService.RenderStepped
	...
	if not Tool or not Handle then
		return notify("Handle Kill", "你需要拿着一个触摸会造成伤害的工具。例如,默认的Sword(剑) .")
	end
	for _, v in ipairs(getPlayer(args[1], speaker)) do
		v = Players[v]
		task.spawn(function()
			...
			notify("Handle Kill Stopped!", v.Name .. " 死亡/离开或你没有装备工具!")
		end)
	end
end)
...
addcmd('autoclick',{},function(args, speaker)
	if mouse1press and mouse1release then
		...
		notify('鼠标自动点击器',"你的注入器无法使用鼠标自动点击器")
	end
end)
	...
	if player:IsInGroup(RolewatchData.Group) then
		if tostring(player:GetRoleInGroup(RolewatchData.Group)):lower() == RolewatchData.Role:lower() then
			if RolewatchData.Leave == true then
				...
				notify("群组检测", "玩家 \"" .. tostring(player.Name) .. "\" 加入的群组 \"" .. RolewatchData.Role .. "\"")
			end
		end
	end
end)
...
addcmd("rolewatch", {}, function(args, speaker)
	...
	if groupId and roleName then
		...
		notify("群组检测", "正在检测的群组 ID \"" .. tostring(groupId) .. "\" 和群组名字 \"" .. roleName .. "\"")
	end
end)
...
addcmd("rolewatchleave", {"unrolewatch"}, function(args, speaker)
	...
	notify("群组检测", RolewatchData.Leave and "离开检测已启用" or "离开检测已禁用")
end)
	...
	if game.CreatorType == Enum.CreatorType.Group then
		...
		staffwatchjoin = Players.PlayerAdded:Connect(function(player)
			...
			if result.Staff then
				notify("员工检测", formatUsername(player) .. " 是一个 " .. result.Role)
			end
		end)
		for _, player in pairs(Players:GetPlayers()) do
			local result = getStaffRole(player)
			if result.Staff then
				table.insert(found, formatUsername(player) .. " 是一个 " .. result.Role)
			end
		end
		if #found > 0 then
			notify("员工检测", table.concat(found, ",\n"))
		else
			notify("员工检测", "已启用")
		end
	else
		notify("员工检测", "游戏不属于任何群组")
	end
end)
...
addcmd('clearnilinstances',{'nonilinstances','cni'},function(args, speaker)
	if getnilinstances then
		...
		notify('不兼容注入器','您的注入器不支持此命令(缺少 getnilinstances)')
	end
end)
...
addcmd("unantivoid", {"noantivoid"}, function(args, speaker)
	...
	antivoidloop = nil
	if args[1] ~= "nonotify" then notify("antivoid", "已禁用") end
end)
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify('版本落后','在 infyiff.github.io获取新版(无中文)')
		end
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("设备不稳定", "在移动设备上, Infinite Yield 可能存在运行不正常的问题或功能.") end
end)
